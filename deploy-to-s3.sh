...
aws s3 cp ./packaged-template.yaml "s3://sammarks-cf-templates/webm-mp3/$PACKAGE_VERSION/template.yaml"
aws s3 cp ./packaged-template.yaml "s3://sammarks-cf-templates/webm-mp3/template.yaml"
...
aws cloudformation package \
  ...
  --output-template-file packaged-template.yaml
aws s3 cp ./packaged-template.yaml "s3://sammarks-cf-templates-us-east-2/webm-mp3/$PACKAGE_VERSION/template.yaml"
aws s3 cp ./packaged-template.yaml "s3://sammarks-cf-templates-us-east-2/webm-mp3/template.yaml"
